...
local function user_spawn(player)
  ...
  if user_id ~= nil and vRP.isFirstSpawn(user_id) then
    ...
    vRPclient.notify(player,{"Willkommen auf dem RalfingerLP vRP Server!"})
    vRPclient.notify(player,{"Um das Menü richtig zu benutzen, ändere deine Telefon 'hoch' Taste."})
  end
end
